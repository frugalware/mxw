...
class config:
	...
	database = {
			...
			"branches": "Frugalware has two branches. -current is about new features and new functionality is pushed there daily. -stable has major updates twice a year with an upgrade howto and between the major updates there are only security-, but- and documentations fixes."
			}
	commands = {
			# operator commands
			"opme": opme,
